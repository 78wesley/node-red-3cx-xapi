...
describe('xapi node', function () {
    ...
    it('should be loaded', function (done) {
        var flow = [{ id: 'n1', type: 'xapi', name: 'xapi' }];
        helper.load(node, flow, function () {
            var n1 = helper.getNode('n1');
            n1.should.have.property('name', 'xapi');
            done();
        });
    });
    ...
    it('should handle ListActiveCall()', function (done) {
        var flow = [
            { id: 'n1', type: 'xapi', name: 'xapi',
                ...
                wires: [['n3']],
                service: 'n2' },
            { id: 'n2', type: 'xapi-service', host: 'http://<host name>' }, // (4) define host name
            { id: 'n3', type: 'helper' }
        ];
        helper.load(node, flow, function () {
